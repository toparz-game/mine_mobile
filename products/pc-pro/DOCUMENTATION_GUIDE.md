...
#### ⚡ **クイック修正**
- **作業**: メソッド名修正、パラメータ調整、簡単な機能追加
- **推奨**: `QUICK_REFERENCE.md` → "修正パターン別対応法"
- **理由**: コピペで使える修正コードが豊富

#### 🔧 **標準的修正**
- **作業**: アルゴリズム修正、新メソッド追加、テスト修正
- **推奨**: `AI_DEBUG_GUIDE.md` → "メソッド別実装位置マップ"
- **理由**: 正確な位置情報・修正指針が必要

#### 🏗️ **大規模修正**
- **作業**: アーキテクチャ変更、Phase追加、全面リファクタリング
...
#### 🎯 **目的明確化**
- **修正**: 問題解決が目的 → AI_DEBUG_GUIDE.md 中心
- **開発**: 機能拡張が目的 → COMPREHENSIVE_DEVELOPER_GUIDE.md 中心
